...
tt.years <- 2017
tt.git <- "https://github.com/bpb27/
trump_tweet_data_archive/raw/master/condensed_{y}.json.zip"
  ...
  labs(
    ...
    title = glue(
      ...
      y = ifelse(
        ...
        tt.years)),
    subtitle = "Tweets plotted by month and minute.
    Collected from trumptwitterarchive.com.",
    color = "Tweet Density") +
  scale_color_viridis(
    breaks = c(
      max(tt.df$density),
